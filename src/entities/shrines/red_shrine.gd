...
func apply_on_spell(spell: Spell):
	...
	var effects = SpellEffectsDb.random_effects_for_spell_from_pool("positive", spell, 1, 3, true) as Array
...
func get_description():
	return "Enhances a spell with 1-3 random\npositive effects and 0-2 negative effects"
