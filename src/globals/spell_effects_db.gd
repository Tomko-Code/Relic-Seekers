...
var effects = {
	random = [
		...
		[RapidFireSpellEffect.new().init(2),15],
		[RapidFireSpellEffect.new().init(3),15],
		[RapidFireSpellEffect.new().init(4),10],
		[BounceEffect.new(), 10],
		...
		[MasterOfFlames.new().init(1), 15],
		[MasterOfFlames.new().init(2), 15],
		[MasterOfFlames.new().init(3), 15],
		[MasterOfFlames.new().init(3), 10],
		[ExplosiveEffect.new().init(0), 10],
		[ExplosiveEffect.new().init(1), 10],
		[ExplosiveEffect.new().init(2), 10],
		[ChainEffect.new().init(0), 10],
		[ChainEffect.new().init(1), 10],
	]
}
